...
Four things this file does *not* carry in full. The trap list lives in
...
twice the load budget, and *Stack* indexes both. None is auto-loaded, on purpose, and the
