...
The one thing this file does *not* carry in full is the trap list --- 147 entries
...
- **It would forbid reusing tpdf code in private or work repositories.** Lifting tpdf's
  text extraction or page-splitting into an internal tool that processes customer
...
titles. Only the titles are here, because there are 147 of them and the full text
was 93% of this file --- an instruction budget spent on the 146 traps that are not
