 ...
 * everywhere else. The find entry is here rather than in a menu of its own
 * because searching *within what you just selected* is the one search option
 * whose subject is the selection.
 */
