...
MUTATIONS = [
    ...
    Mutation('layout: count the space a line broke at as ink', 'src/textedit/layout.rs', "metrics.gapped_layout(text.trim_end_matches(' '), size, spacing, word_spacing, gap)?;", 'metrics.gapped_layout(text, size, spacing, word_spacing, gap)?;', 'wrapping_fits_a_line_by_its_words_not_the_space_it_broke_at'),
