...
MUTATIONS = [
    ...
    Mutation('push: the preview crop stops at the box', 'src/textedit/layout.rs', '    for (show, shift) in &moved {\n        let Some(other) = page', '    for (show, shift) in &moved[..0] {\n        let Some(other) = page', 'the_preview_extent_covers_the_run_the_draft_pushes'),
