...
MUTATIONS = [
    ...
    Mutation("textedit: omit translated text position", "src/textedit.rs", 'shift_position(&mut page_matrix, page_transform[4], page_transform[5])?;', 'shift_position(&mut page_matrix, 0., 0.)?;', "textedit_translated_hitboxes_match_absolute_positions_after_crop_and_rotation"),
    ...
    Mutation("textedit: accept arbitrary page transforms", "src/textedit.rs", 'values[..4].iter().zip([1., 0., 0., 1.])', 'values[..4].iter().zip([1., 0., 0., 1.]).take(0)', "textedit_page_translations_refuse_unbounded_or_nontranslation_matrices"),
