...
MUTATIONS = [
    ...
    Mutation('keep breaks: a paragraph break may close', 'src/textedit/layout.rs', '    ahead && after < blank - 0.1', '    ahead && after < -f64::MAX', 'a_paragraph_with_no_room_below_is_refused_with_the_reason'),
    Mutation('keep breaks: text behind counts too', 'src/textedit/layout.rs', '    ahead && after < blank - 0.1', '    (ahead || true) && after < blank - 0.1', 'the_next_paragraph_moves_down_when_the_lines_would_land_on_it'),
    ...
    Mutation('keep breaks: a blank line is a whole pitch', 'src/textedit/layout.rs', '    let blank = pitch - (slack[cross] - 0.1);\n    ahead && after < blank - 0.1', '    let blank = pitch;\n    ahead && after < blank - 0.1', 'a_paragraph_with_no_room_below_is_refused_with_the_reason'),
