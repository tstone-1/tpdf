...
MUTATIONS = [
    ...
    Mutation('nested tags: allow any leaf role', 'src/textedit/tagging.rs', 'if tag != b"NonStruct" && !(plain.tag == b"LI" && matches!(tag, b"Lbl" | b"LBody")) {', 'if false {', 'textedit_nested_ownership_cycles_and_extra_levels_are_refused_atomically'),
