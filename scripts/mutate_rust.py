...
MUTATIONS = [
    ...
    Mutation('mapped: decode bytes without font mapping', 'src/textedit/fonts.rs', 'codes[code as usize]\n                    .map(super::slot_character)', 'Some(code)\n                    .map(super::slot_character)', 'textedit_symbolic_codes_round_trip_without_changing_font_resources'),
    ...
    Mutation('single ranges: allow unproven Latin-1 targets', 'src/textedit/fonts/mapping.rs', '(32..=126).contains(&ch) || ch == 0x2013', '(32..=255).contains(&ch) || ch == 0x2013', 'textedit_mapping_refuses_ambiguous_partial_and_extended_data'),
