...
MUTATIONS = [
    ...
    Mutation('CFF mapping: forget remapped space', 'src/textedit/fonts/cff.rs', 'Ok(None) if slot == 32', 'Ok(None) if code == 32', 'textedit_cff_custom_encoding_roundtrips_original_codes_and_word_spacing'),
