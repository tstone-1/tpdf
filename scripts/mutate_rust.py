...
MUTATIONS = [
    ...
    Mutation('CFF Unicode: offer NBSP without reader agreement', 'src/textedit/fonts/cff/encoding.rs', 'if *slot == Some(0xa0) {', 'if false {', 'textedit_cff_unicode_missing_maps_glyphs_and_unmapped_fonts_never_guess'),
    ...
    Mutation("textedit: forget saved fill colour space", "src/textedit.rs", "states.push((\n                    selected_font,\n                    leading,\n                    page_transform,\n                    fill_components,\n                    clip,\n                    spacing,\n                    word_spacing,\n                ));", "states.push((selected_font, leading, page_transform, 1, clip, spacing, word_spacing));", "textedit_colours_restore_state_and_preserve_operators"),
    ...
    Mutation("textedit: forget saved page translation", "src/textedit.rs", 'states.push((\n                    selected_font,\n                    leading,\n                    page_transform,\n                    fill_components,\n                    clip,\n                    spacing,\n                    word_spacing,\n                ));', 'states.push((selected_font, leading, [1., 0., 0., 1., 0., 0.], fill_components, clip, spacing, word_spacing));', "textedit_page_translations_compose_restore_and_preserve_following_runs"),
    ...
    Mutation('spacing: ignore spacing in kerning arrays', 'src/textedit.rs', 'metrics.spaced_layout(&fragment, size, spacing, word_spacing)?', 'metrics.spaced_layout(&fragment, size, 0., word_spacing)?', 'textedit_spacing_measures_character_steps_and_tj_fragments'),
    ...
    Mutation('word spacing: ignore kerning fragment spacing', 'src/textedit.rs', 'metrics.spaced_layout(&fragment, size, spacing, word_spacing)?', 'metrics.spaced_layout(&fragment, size, spacing, 0.)?', 'textedit_word_spacing_measures_combined_steps_and_kerning_fragments'),
