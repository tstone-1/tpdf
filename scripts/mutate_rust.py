...
MUTATIONS = [
    ...
    Mutation('lists: allow standard list role remap', 'src/textedit/tagging.rs', '|| matches!(key.as_slice(), b"L" | b"LI" | b"Lbl" | b"LBody")', '|| false', 'textedit_lists_refuse_wrong_roles_owners_cycles_and_semantic_overrides'),
