...
MUTATIONS = [
    ...
    Mutation('painted rectangles: omit tagged paint content', 'src/textedit.rs', 'tags.paint();', '// paint omitted', 'textedit_tagged_painted_content_preserves_structure_and_refuses_empty_items'),
