...
MUTATIONS = [
    ...
    Mutation('wrap room: land on the next paragraph', 'src/textedit/layout.rs', '            .any(|(other, moves)| !*moves && lands(*old, new, *other, (slack, cross)))', '            .any(|(other, moves)| false && !*moves && lands(*old, new, *other, (slack, cross)))', 'a_paragraph_with_no_room_below_is_refused_with_the_reason'),
