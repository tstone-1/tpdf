...
MUTATIONS = [
    ...
    Mutation("textedit: omit page scale from hitbox width", "src/textedit.rs", 'x + advance * page_matrix[0]', 'x + advance * matrix[0]', "textedit_scaled_hitboxes_match_absolute_matrices_after_crop_and_rotation"),
