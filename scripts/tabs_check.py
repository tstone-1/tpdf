...
def main() -> int:
    ...
    parser.add_argument("--phase", choices=("tabs", "forms", "signatures", "textedit", "textedit-dash", "textedit-agenda", "textedit-agenda-page2", "textedit-w3c", "textedit-latin1", "textedit-cid-latin1", "textedit-overhang", "textedit-multipage", "textedit-wrapped"), default="tabs")
