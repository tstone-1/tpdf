...
def main() -> int:
    ...
    parser.add_argument("--phase", choices=("tabs", "forms", "signatures", "textedit", "textedit-latin1", "textedit-cid-latin1", "textedit-overhang", "textedit-multipage", "textedit-wrapped"), default="tabs")
